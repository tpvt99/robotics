...
class PPO(Algo, Serializable):
    ...
    def build_graph(self):
        ...
        self.update = self.op_phs_dict.update(all_phs_dict)
        ...
        if self.use_ppo_obj:
            ...
            likelihood_ratio = loglikelihood  # hint: here we abuse the variable name and make ppo_legacy and pg share the same var name.
            """YOUR CODE END"""
